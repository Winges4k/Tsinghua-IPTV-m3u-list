...
channels_url = 'https://github.com/bitsbb01/ez-iptvcat-scraper2/blob/main/data/countries/france.json'
...
for i in range(len(channels['Categories'])):
    for j in range(len(channels['Categories'][i]['Channels'])):
        ...
        m3u8_url = 'https://github.com/bitsbb01/ez-iptvcat-scraper2/blob/main/data/countries/' + channels['Categories'][i]['Channels'][j]['Vid'] + '.m3u8'
        f.write(line_1)
        f.write(m3u8_url + '\n')
